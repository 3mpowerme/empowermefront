...
const ContinueConceptualizationPage = ({ showWelcomeMessage = false }) => {
  ...
  const steps = [
    ...
    { id: 2, component: <ConceptualizationWizardStep2 withAutoContinue /> },
    { id: 3, component: <ConceptualizationWizardStep3 withAutoContinue /> },
        ...
        <Switch.Item case={PAY_VIEW}>
          <div className="flex flex-col items-center space-y-5 px-6 md:px-10 lg:px-20 mt-10 md:mt-20">
            <h1 className="text-xl font-bold text-center">
              ¿Quieres desbloquear tu conceptualización?
            </h1>
...
export default ContinueConceptualizationPage;
