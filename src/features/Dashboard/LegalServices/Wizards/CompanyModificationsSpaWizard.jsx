...
export default function CompanyModificationsSpaWizard({
  handleWizardClose,
  handleWizardSuccess,
  companyId,
}) {
    ...
    return [
      {
        ...
        footer:
          'En caso de que sea una Sociedad por Acciones y que hayas contratado igualmente ese servicio, para realizar el proceso se requiere OBLIGATORIAMENTE ingresar a www.registrodeempresasysociedades.cl con rut y clave única de uno de los accionistas de la empresa. Sugerimos que antes de ingresarla, verifiques que es correcta en: https://claveunica.gob.cl/ . Si la empresa tiene más de 1 representante legal, basta con 1 si firman individualmente, si firman en conjunto se requiere la clave única de todos los representantes. Recuerde que un socio o accionista de una empresa NO necesariamente es el representante legal.',
      ...
      },
      {
        ...
        description:
          '¿Necesitas realizar una modificación en tu empresa? En EmpowerMe podemos ayudarte, revisa los detalles y contrata 100% online.',
        footer:
          'El primer plazo del servicio de Modificación de Sociedad por Acciones SpA de 7 días hábiles es contado desde que se recepciona la información solicitada completa y correcta, cualquier error u omisión implicará una nueva solicitud y el plazo de respuesta por nuestra parte se extenderá.',
  ...
  return (
    <WizardProvider
      ...
      globalSubmitApi={{
        method: 'POST',
        url: `/company-modifications-request/${companyId}/company_modifications_spa`,
      }}
