...
const PayBalance = forwardRef(({ onComplete = () => {} }, ref) => {
      ...
      <Switch value={view}>
        ...
        <Switch.Item case={PAY_APPOINTMENT_VIEW}>
          <div className="flex flex-col items-center space-y-5 px-6 md:px-10 lg:px-20 mt-10 md:mt-20">
            <h1 className="text-xl font-bold text-center">
              ¿Necesitas saber cómo va tu empresa en ventas?, ¿calcular cuánto en impuestos deberás
              pagar en la próxima declaración de renta anual?
            </h1>
            <p>
              Es muy importante tener este tipo de información para tomar decisión y prepararte de
              mejor manera para el cumplimiento de tus obligaciones impositivas y su correcta
              tributación. El servicio de Balance o también conocido coloquialmente como prebalance
              es un simulacro de la situación financiera y tributaria de tu empresa en un periodo
              determinado y herramienta fundamental para la toma de decisiones.
            </p>
            <div className="w-1/5">
        ...
        <Switch.Item case={SUCCESSFULL_SUBSCRIPTION_VIEW}>
          <SuccessfullPayment
            ...
            goTo={'taxes_and_accounting/balance'}
          />
        </Switch.Item>
      </Switch>
    </>
