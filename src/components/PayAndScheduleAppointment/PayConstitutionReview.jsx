...
const PayConstitutionReview = forwardRef(({ onComplete = () => {} }, ref) => {
  ...
  const ensureServiceOrder = async () => {
    const payload = {
      serviceCode: 'constitution_review',
      companyId,
      count,
    };
      ...
      <Switch value={view}>
        ...
        <Switch.Item case={PAY_APPOINTMENT_VIEW}>
          <div className="flex flex-col items-center space-y-5 px-6 md:px-10 lg:px-20 mt-10 md:mt-20">
            <h1 className="text-xl font-bold text-center">
              ¿Necesitas tener un mejor entendimiento de cuanto en impuestos pagarás tú, tus socios
              y/o tu empresa?
            </h1>
            <p>
              realizaremos una completa revisión de toda tu situación tributaria y te entregaremos
              un diagnóstico y asesoría respecto del panorama impositivo que nos plantees para
              analizar.
            </p>
            <div className="w-1/5">
        ...
        <Switch.Item case={SUCCESSFULL_SUBSCRIPTION_VIEW}>
          <SuccessfullPayment
            ...
            goTo={'taxes_and_accounting/constitution_review'}
          />
        </Switch.Item>
      </Switch>
    </>
...
export default PayConstitutionReview;
